// Calendly CTA with downloads and quick contact
'use client'
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-400 mb-8 leading-relaxed">
            Ready to discuss how I can drive revenue excellence at {company}
          </p>
        ...
        >
          Available for immediate interviews • Open to relocation
        </motion.p>

        {/* Bio Footer - Acts as page footer */}
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
